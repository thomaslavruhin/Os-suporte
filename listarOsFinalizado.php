...
<meta charset="utf-8">
    ...
    <title> Chamados Finalizados <li><a class="dropdown-item" href="listarOsEmAndamento.php">Chamados Em Andamento</a></li> </title>
    <!-- CSS only -->
...
<br>
    <table class="table table-striped">
      ...
      <?php
        include 'conexao.php';
        $sql= "SELECT * FROM `os_suporte` WHERE statusOs =  'Finalizado'";
