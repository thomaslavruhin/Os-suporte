...
<form action="inserirUsuario.php" method="post">
    ...
    <div class="form-group">
        <label> Senha: </label>
    <input id="password" type="password" name="senhaUsuario" class="form-control" placeholder="Senha" autocomplete="off" required>
    </div>
    <div class="form-group">
        <label> Repetir Senha: </label>
        <input type="password" name="senhaUsuario2" class="form-control" placeholder="Repetir senha" autocomplete="off" required oninput="validaSenha(this)">
        <small> Precisa ser igual a senha digitada acima!</small>
    </div>
    <div class="form-group">
        <label> Nível de Acesso</label>
        <select name="nivelUsuario" class="form-control" ORDER BY DESC>
